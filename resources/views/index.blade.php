...
@section('content')
    <section class="intro">
        @component('partials/content')
            ...
            <br />
            Do elit a enim ab do summis ab elit do et est esse anim esse, probant summis id
            vidisse familiaritatem quo laboris cillum aliquip occaecat, quamquam irure minim
            litteris fore, admodum non tamen te ut dolore adipisicing. De ea concursionibus,
            fugiat ea occaecat in dolor e eu anim consequat ad sunt in pariatur, laboris ad
            pariatur, se minim adipisicing, te iudicem domesticarum, aliqua mentitum
            praetermissum. Do non consectetur, ex sunt incurreret despicationes.Quo quis
            sint iis nescius. Ad noster officia fidelissimae, quo sunt velit culpa
            cupidatat. A se dolor incididunt. Illum vidisse do comprehenderit.
        @endcomponent
    </section>
